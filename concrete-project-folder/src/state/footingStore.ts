...
import type { FootingInput, FootingLayout } from '../domain/footing/types';
import { CORNER_SIDES, EDGE_SIDES, POSITIONS, SIZE_MODES, validateFootingInput } from '../domain/footing/validate';
  ...
  persist(
    ...
    }),
    {
      ...
      merge: (persisted, current) => {
        const result = parseFootingProject({ ...(asObj(persisted) ?? {}), app: 'rc-footing-wsd' });
