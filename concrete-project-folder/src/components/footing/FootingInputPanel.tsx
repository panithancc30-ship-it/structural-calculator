import { ACI318_WSD_FOOTING as K } from '../../domain/codes/aci318Wsd';
import type { ColumnPosition, CornerSide, EdgeSide, FootingDims, FootingInput, SizeMode } from '../../domain/footing/types';
