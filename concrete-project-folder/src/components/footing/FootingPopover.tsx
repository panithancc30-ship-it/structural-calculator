import type { FootingDirection } from '../../domain/footing/analyzeFooting';
import { setBarSet, setBottom } from '../../domain/footing/layoutOps';
import type { BarDir, BarSet, FootingLayout } from '../../domain/footing/types';
import { cmToM, fmt } from '../../domain/format';
import { MAIN_BAR_SIZES } from '../../domain/rebar';
