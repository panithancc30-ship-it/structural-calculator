...
import { canRotate, PILE_COUNTS } from '../../domain/pilecap/piles';
import type { AutoMode, PileArrangement, PileCapInput, PileShape } from '../../domain/pilecap/types';
import { MAIN_BAR_SIZES, STEEL_GRADES } from '../../domain/rebar';
