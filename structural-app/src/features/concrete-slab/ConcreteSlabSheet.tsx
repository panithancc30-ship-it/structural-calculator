...
const BASE_NOTES = [
  ...
  'โมเมนต์จากสัมประสิทธิ์โดยประมาณ ACI 8.3.3 (ต้องมี LL ≤ 3·DL และช่วงติดกันต่างกันไม่เกิน 20%)',
  'ควบคุมการโก่งตัวด้วยความหนาขั้นต่ำ ไม่ได้คำนวณค่าการโก่งตัวจริง',
]

const TWO_WAY_NOTE =
  'แบ่งน้ำหนักสองทางด้วย Rankine–Grashof (wx·lx⁴ = wy·ly⁴) ออกแบบทีละแถบกว้าง 1 ม. ' +
