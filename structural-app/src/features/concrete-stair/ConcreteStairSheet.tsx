...
const NOTES = [
  'หน่วย kg, cm, ksc — น้ำหนักบรรทุกเป็นแรงใช้งานต่อพื้นที่ฉายราบ ไม่คูณตัวประกอบ',
  'ออกแบบเป็นแผ่นพื้นทางเดียวพาดตามยาวบันได แถบกว้าง 1 ม. ช่วงราบวัดระหว่างศูนย์กลางคานรองรับ — ' +
    'โมเมนต์ช่วงยึดหมุนจากสถิตศาสตร์ของน้ำหนักแผ่เป็นช่วง แล้วใช้สัมประสิทธิ์ ACI 8.3.3 กับน้ำหนักเทียบเท่า 8M/L²',
  'ปลายที่หล่อติดคานใส่เหล็กบนรับ w·L²/24 — ที่มุมหักด้านในของผิวรับแรงดึง เหล็กวางไขว้เลยจุดหักแทนการดัดตามมุม',
  'ควบคุมการโก่งตัวด้วยความหนาขั้นต่ำเท่านั้น — ขนาดขั้นบันไดตรวจตามกฎกระทรวงฉบับที่ 55 ควรทานกับฉบับปัจจุบัน',
]
