...
import type { SteelBeamResult } from '@/engine/steel/beamASD'
import { fmt, weightDecimals } from '@/engine/shared/units'

export function SteelBeamResultView({ result }: { result: SteelBeamResult }) {
  return (
    <CalcResultView
      ...
      diagramTitle="รูปตัดเหล็กและทิศทางของแรง"
