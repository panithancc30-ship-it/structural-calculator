...
import { computeGeometry, type SectionGeometry } from '@/engine/concrete/design/barLayout';
import { stirrupText } from '@/engine/concrete/design/stirrupConfig';
import { REBARS, type BarName } from '@/engine/concrete/rebar';
import type { BeamInput, Face, SectionKey, SectionLayout } from '@/engine/concrete/types';
